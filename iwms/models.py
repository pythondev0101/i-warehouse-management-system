...
class Zone(Base,Admin):
    ...
    __list_view_url__ = 'bp_iwms.zones'
...
class BinLocation(Base,Admin):
    ...
    __list_view_url__ = 'bp_iwms.bin_locations'
...
class Category(Base,Admin):
    ...
    __amicon__ = 'pe-7s-network'
    __list_view_url__ = 'bp_iwms.categories'
...
class StockItem(Base,Admin):
    ...
    __list_view_url__ = 'bp_iwms.stock_items'
...
class Source(Base,Admin):
    ...
    __amicon__ = 'pe-7s-news-paper'
    __list_view_url__ = 'bp_iwms.sources'
...
class StockReceipt(Base,Admin):
    ...
    __amicon__ = 'pe-7s-news-paper'
    __list_view_url__ = 'bp_iwms.stock_receipts'
...
class Putaway(Base,Admin):
    ...
    __list_view_url__ = 'bp_iwms.putaways'
...
class Supplier(Base,Admin):
    ...
    __list_view_url__ = 'bp_iwms.suppliers'
...
class Term(Base,Admin):
    ...
    __list_view_url__ = 'bp_iwms.terms'
...
class PurchaseOrder(Base,Admin):
    ...
    __list_view_url__ = 'bp_iwms.purchase_orders'
...
class StockItemType(Base,Admin):
    ...
    __amicon__ = 'pe-7s-network'
    __list_view_url__ = 'bp_iwms.stock_item_types'
...
class ShipVia(Base,Admin):
    ...
    __list_view_url__ = 'bp_iwms.ship_via'
...
class Client(Base,Admin):
    ...
    __list_view_url__ = 'bp_iwms.clients'
...
class InventoryItem(Base,Admin):
    ...
    __amicon__ = 'pe-7s-download'
    __list_view_url__ = 'bp_iwms.inventory_items'
...
class WarehouseBinLocation(Admin):
    __amname__ = 'warehouse_bin_location'
    __amdescription__ = 'Warehouse Bin Location'
    __amicon__ = 'pe-7s-network'
    __list_view_url__ = 'bp_iwms.warehouse_bin_location'


class ColdStorage(Admin):
    __amname__ = 'cold_storage'
